function u = fcn_nx2_N5(r, x)
% ============================================================
%  MPC por QP (quadprog)  -  Planta 2x2, horizonte N = 5
%  Caso: nx = 2, N = 5   (Control de Procesos - Lab 4)
%
...
% --- PLANTA EJEMPLO 2x2 (cadena de integradores discreta) ---
%     >>> REEMPLAZA Ad y Bd por tu modelo real 2x2 <<<
