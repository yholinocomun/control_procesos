function u = fcn_nx6_N1(r, x)
% ============================================================
%  MPC por QP (quadprog)  -  Planta 6x6, horizonte N = 1
%  Caso: nx = 6, N = 1   (Control de Procesos - Lab 4)
%
...
N  = 1;      % horizonte de prediccion/control
nx = 6;      % numero de estados
nu = 1;       % numero de entradas

% ----------------- Modelo discreto de la planta -------------
% --- PLANTA EJEMPLO 6x6 (cadena de integradores discreta) ---
%     >>> REEMPLAZA Ad y Bd por tu modelo real 6x6 <<<
