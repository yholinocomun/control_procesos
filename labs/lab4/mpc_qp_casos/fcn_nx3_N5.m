function u = fcn_nx3_N5(r, x)
% ============================================================
%  MPC por QP (quadprog)  -  Planta 3x3, horizonte N = 5
%  Caso: nx = 3, N = 5   (Control de Procesos - Lab 4)
%
...
N  = 5;      % horizonte de prediccion/control
nx = 3;      % numero de estados
nu = 1;       % numero de entradas

% ----------------- Modelo discreto de la planta -------------
% --- PLANTA EJEMPLO 3x3 (cadena de integradores discreta) ---
%     >>> REEMPLAZA Ad y Bd por tu modelo real 3x3 <<<
